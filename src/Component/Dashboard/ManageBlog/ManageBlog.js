...
const ManageBlog = () => {
    ...
    useEffect(() => {
        fetch('  https://afternoon-temple-99986.herokuapp.com/blogs')
            .then(res => res.json())
    ...
    const handleDelete = (id) => {
        ...
        fetch(`  https://afternoon-temple-99986.herokuapp.com/deleteBlogs/${id}`, {
            method : "DELETE"
        })
        .then(res => res.json())
        .then(data=>{
                                                        ...
                                                        <td className="w-25 text-light">
                                                            {
                                                                blog.image ? <img style={{ width: "8rem", height: "8rem" }} src={`data:image/png;base64,${blog.image.img}`} alt="" />
                                                                    :
                                                                    <img style={{ width: "8rem", height: "8rem" }} className="img-fluid mb-3" src={`  https://afternoon-temple-99986.herokuapp.com/${blog.img}`} alt="" />
                                                            }
                                                        </td>
